...
document.addEventListener("DOMContentLoaded",()=>{document.querySelectorAll(".carousel").forEach(e=>{const t=e.querySelector(".carousel-track"),r=Array.from(t.children);var c=e.querySelector(".next"),a=e.querySelector(".prev");const n=e.querySelector(".carousel-dots");let o=0;r.forEach((e,t)=>{var r=document.createElement("button");0===t&&r.classList.add("active"),n.appendChild(r)});const l=Array.from(n.children);function s(e){t.style.transform=`translateX(-${100*e}%)`,l.forEach(e=>e.classList.remove("active")),l[e].classList.add("active"),o=e}c.addEventListener("click",()=>{s((o+1)%r.length)}),a.addEventListener("click",()=>{s((o-1+r.length)%r.length)}),l.forEach((e,t)=>{e.addEventListener("click",()=>s(t))})})});
